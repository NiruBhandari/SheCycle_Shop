...
if (isset($_GET['delete_id'])) {
    ...
    $deleteSql = "DELETE FROM sellers WHERE id = $deleteId";
    ...
    $resetAutoIncrementSql = "ALTER TABLE sellers AUTO_INCREMENT = 1";
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='../Seller/editProfileS.php?id=" . $row['id'] . "' class='action-button edit'>Edit</a>";
                echo " ";
