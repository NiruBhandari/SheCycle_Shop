...
// Fetch the seller's current details using their session seller_id
...
<html>
<head>
    <title>Edit Seller Profile - SheCycle Shop</title>
    ...
    <script>
        ...
        function setSelectedValues() {
            document.getElementById('province').value = '<?php echo $seller['province']; ?>';
            populateCities();
            document.getElementById('city').value = '<?php echo $seller['city']; ?>';
            populateDistricts();
            document.getElementById('district').value = '<?php echo $seller['district']; ?>';
        }
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="update_profileProcess.php" method="POST">
            ...
            <select id="gender" name="gender" required>
                <option value="Male" <?php echo ($seller['gender'] == 'Male') ? 'selected' : ''; ?>>Male</option>
                <option value="Female" <?php echo ($seller['gender'] == 'Female') ? 'selected' : ''; ?>>Female</option>
                <option value="Other" <?php echo ($seller['gender'] == 'Other') ? 'selected' : ''; ?>>Other</option>
            </select>
            
            <label for="location">Address:</label>
            <input type="text" id="location" name="location" value="<?php echo htmlspecialchars($seller['location']); ?>" required>
